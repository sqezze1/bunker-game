...
import { BrowserRouter as Router, Routes, Route, useNavigate } from "react-router-dom";  // Роутинг
import Lobby from "./pages/Lobby";  // Страница лобби
import Scenario from "./pages/Scenario";  // Страница сценария игры
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/lobby" element={<Lobby />} /> {/* Лобби, куда попадают игроки */}
        <Route path="/scenario/:roomId" element={<Scenario />} /> {/* Сценарий игры */}
      </Routes>
    </Router>
  );
}
